...
public class ILS : MonoBehaviour
{
    ...
    public float glideSlopeAltitude = 2500;
    public float localiserHeading = 0;
    public float localiserMaxAngleDiff = 15; // change later only for testing
    ...
    {
        if (planeToDelete == landingPlane) { landingPlane = null; }
        if (planeToDelete == secondLandingPlane) { secondLandingPlane = null; }
